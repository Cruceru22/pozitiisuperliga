...
export default function FootballNewsClient({
  ...
  if (error) {
    return (
      <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded mb-4 flex items-start">
        ...
        {articles.map((article, index) => (
          ...
          >
            ...
            <div className="px-5 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
              <div className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-5 rounded-lg transition-all duration-300 w-full justify-center shadow-sm hover:shadow-md">
                Citește mai mult
